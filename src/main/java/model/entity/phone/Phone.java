...
public class Phone {
	...
	public static Person searchByTelephone(String telephone){
		...
		try{
			stmt = con.prepareStatement("select PE.id_person, PE.name_person, PH.phone, A.id_address from person PE, phone PH, address A where A.id_address = PE.id_address and PE.id_person = PH.id_person and PH.phone = ?");
			...
			FxDialogs.showException("Erro de Leitura!","class: "+"" + " " + " - " + ex.getMessage(),ex);
		}
		finally{
